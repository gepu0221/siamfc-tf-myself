...
def build_tracking_graph(final_score_sz, design, env):
    ...
    #design.exemplar_sz=127(最后裁减得到的尺寸：127*127）
    ...
    #design.search_sz=255（最后裁剪得到的三个crop为255*255）
    ...
    # upsample the score maps(均调整乘final_score_sz*final_score_sz大小）
